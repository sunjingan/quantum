...
COMMON_COMMAND = "source activate.sh && python runs/etf_loop/run_single_factor_followups_v1.py"
...
def main() -> None:
    ...
    for group in ["widea_window", "widea_threshold", "exph_exposure", "exph_n", "current_score"]:
        ...
        lines += [
            ...
            f"- repro: `source activate.sh && python runs/etf_loop/run_single_factor_followups_v1.py --group {group}`",
        ]
        if group == "exph_n":
