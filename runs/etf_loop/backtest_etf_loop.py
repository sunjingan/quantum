...
Usage:
  ...
  python runs/etf_loop/backtest_etf_loop.py --start 2021-01-01 --end 2026-06-22

  # Fetch ETF data from Tushare (fund_daily for the pool)
  python runs/etf_loop/backtest_etf_loop.py --fetch --start 2018-01-01 --end 2026-06-22

  # Custom parameters
  python runs/etf_loop/backtest_etf_loop.py --holdings-num 3 --lookback 30 --no-rsi --no-volume
"""
