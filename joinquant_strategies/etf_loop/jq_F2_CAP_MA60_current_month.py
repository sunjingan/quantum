...
# Strategy: F2_CAP_MA60_current_month
# JoinQuant account name suggestion: F2_CAP_MA60_current_month_paper
...
def initialize(context):
    setup_platform()
    g.strategy_name = 'F2_CAP_MA60_current_month'
    g.account_name = 'F2_CAP_MA60_current_month_paper'
    ...
    g.use_adaptive = False
    g.adaptive_window = 15
    g.adaptive_tiers_ret = []
    g.adaptive_tiers_n = []
    g.adaptive_tiers_exposure = []
