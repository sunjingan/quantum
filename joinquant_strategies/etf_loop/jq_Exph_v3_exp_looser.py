...
# Strategy: Exph_v3_exp_looser
# JoinQuant account name suggestion: Exph_v3_exp_looser_paper
...
def initialize(context):
    setup_platform()
    g.strategy_name = 'Exph_v3_exp_looser'
    g.account_name = 'Exph_v3_exp_looser_paper'
