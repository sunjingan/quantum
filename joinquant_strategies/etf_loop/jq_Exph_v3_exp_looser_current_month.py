...
# Strategy: Exph_v3_exp_looser_current_month
# JoinQuant account name suggestion: Exph_v3_exp_looser_current_month_paper
...
def initialize(context):
    setup_platform()
    g.strategy_name = 'Exph_v3_exp_looser_current_month'
    g.account_name = 'Exph_v3_exp_looser_current_month_paper'
    ...
    g.adaptive_tiers_ret = [0.05, 0.02, 0.0, -0.03, -0.06]
    g.adaptive_tiers_n = [5, 5, 4, 4, 3, 0]
    g.adaptive_tiers_exposure = [1.0, 1.0, 0.85, 0.65, 0.45, 0.0]
